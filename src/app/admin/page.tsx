    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 24 }}>
        {metrics.map(({ label, value, color, href }) => (
          <Link key={href} href={href} className="admin-metric-card">
            <p style={{ margin: "0 0 8px", fontSize: 10, fontWeight: 950, textTransform: "uppercase", color: "var(--gray-500)", letterSpacing: "0.06em" }}>
              {label}
            </p>
            <strong style={{ fontSize: 28, fontWeight: 950, color, lineHeight: 1 }}>
